...
import { FormProvider } from "@react-formgen/json-schema";
import { FormGenerator } from "~/components/FormGenerator";

const createAssigmentAreaSchema = {
  type: "object",
  title: "Edit assignment area",
  description: "Fill in the form below to edit the assignment area.",
  properties: {
    name: {
      type: "string",
      title: "Name",
...
export async function loader({ params }: LoaderFunctionArgs) {
  ...
  async function getEditAssignmentAreaSchema() {
    ...
    createAssigmentAreaSchema.properties.parentArea.oneOf =
